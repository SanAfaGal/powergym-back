...
from app.api.v1.endpoints import auth, users, roles, clients, face_recognition, attendances, plans, payments, subscriptions, products, stock, movements, reports, statistics, rewards
